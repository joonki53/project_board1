...
<h2>go to <a href="login_index.html" target="_blank">HOME / </a><a href="join.php" target="_blank">JOIN / </a><a href="project_logout.php" target="_blank">Logout</a></h2>
  ...
  <thead>
    <tr>
      ...
      <form method="post" action="member_search.php">
        ...
        <input id=text type="text" class='input_text' name="search2"  placeholder="아이디를 입력하세요." onkeydown="enterSearch()"/></span>
        <input type="submit" class='sch_smit' value="검색" onclick="myFunction()"/>
       </form>
      <?php
        $select_query = "select * FROM member ORDER BY idx DESC";        
